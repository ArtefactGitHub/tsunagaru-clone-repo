...
#
Dir[Rails.root.join('spec', 'support', 'rails', '**', '*.rb')].each { |f| require f }
...
RSpec.configure do |config|
  ...
  config.include TestHelpers::Rails::Systems, type: :system
  config.include TestHelpers::Rails::EnvHelper
