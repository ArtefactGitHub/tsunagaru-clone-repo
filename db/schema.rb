...
ActiveRecord::Schema.define(version: 2019_02_10_002618) do
  ...
  create_table "room_notifiers", force: :cascade do |t|
    t.bigint "room_id"
    t.bigint "user_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["room_id", "user_id"], name: "index_room_notifiers_on_room_id_and_user_id", unique: true
    t.index ["room_id"], name: "index_room_notifiers_on_room_id"
    t.index ["user_id"], name: "index_room_notifiers_on_user_id"
  end
